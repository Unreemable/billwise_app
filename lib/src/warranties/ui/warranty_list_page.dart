                ...
                builder: (context, snap) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final start =
                      (d['start_date'] as Timestamp?)
                          ?.toDate()
                          .toLocal();
                      final end =
                      (d['end_date'] as Timestamp?)
                          ?.toDate()
                          .toLocal();
                      final provider =
                      (d['provider'] ?? 'Warranty').toString();
